...
from utils.basic_utils import recursively_update
...
class CONFIG(object):
    ...
    def __init__(self, parser):
        ...
        modified_keys = [a for a in modified_args if a.startswith('--')]
        ...
        from utils.project_utils import initiate_environment
    ...
    def update_config(self, *args, **kwargs):
        ...
        recursively_update(self.config, new_cfg)
