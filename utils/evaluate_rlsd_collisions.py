...
col_prob = cls_cls_tch/(cls_cls_tch_num+1)
_, ax2 = plt.subplots(figsize=(14,10))
ax2 = sns.heatmap(col_prob, annot=True, fmt='.2f', xticklabels=data_config.RLSD32CLASSES, yticklabels=data_config.RLSD32CLASSES)
